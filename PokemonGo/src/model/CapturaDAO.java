...
public class CapturaDAO {
    ...
    public boolean darCaptura(int id_coach, int num_pokemon, int CP,String shiny) throws SQLException
    {
        int rows;
        if (conn_principal!=null)
        {
            String query = "INSERT INTO MOCHILA (id_entrenador,num_pokemon,CP,shiny) "
                    + " VALUES (?,?,?,?)";
